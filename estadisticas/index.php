<?php   
 ...
 include("../assets/estadistica/pChart/pChart.class.php"); 
 include("../assets/estadistica/pChart/pData.class.php"); 
 include("../assets/estadistica/pChart/pDraw.class.php"); 
 include("../assets/estadistica/pChart/pImage.class.php"); 
 /* --> \\ CREAMOS Y LLENAMOS EL OBJETO "pData: DATOS PARA EL GRÁFICO" // <--*/ 
 $MyData = new pData();   
 // Preparamos los juegos de datos a mostrar "Valores del eje Y"<br>
 $MyData->addPoints(array(1,0,4,2),"Alex"); 
 $MyData->addPoints(array(5,7,3,1),"Carlos"); 
 // Título del eje Y Axis<br>
 $MyData->setAxisName(0,"Experiencia");
 // Valores del eje X<br>
 $MyData->addPoints(array("C++","Java","PHP","PASCAL"),'Lenguajes');
 $MyData->setSerieDescription('Lenguajes','Lenguajes de Programación');
 // Título del eje X Abscisa<br>
