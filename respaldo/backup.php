...
//$passwd = "";
//$host = "localhost";
$bd = "u722144108_stock"; // nombre de la base de datos
$fecha = date('d-m-Y');
$nombre = "backupStock" . $fecha . ".sql"; //Este es el nombre del archivo a generar
...
if (empty($tablas)) {
    ...
    $respuesta = mysqli_query($_SESSION['con'], $consulta)
...
$info['mysqlver'] = mysqli_get_server_info($_SESSION['con']);
    ...
    while ($fila = mysqli_fetch_array($respuesta, MYSQLI_ASSOC)) {
        ...
        foreach ($columnas as $columna) {
            if (gettype($fila[$columna]) == "NULL") {
                ...
                $values[] = "'" . mysqli_real_escape_string($_SESSION['con'], $fila[$columna]) . "'";
            }
        }
