...
<div class="empty-account-page">
    <div class="container">
        <div class="row congratz">
            <h1>¡Tu cuenta se cerró!</h1><em></em>
            <br>
            <br>
            <!-- <h2 id="pathName"><em></em></h2> -->
        </div>
        <div class="row message">
            <p><strong>www.elemporioelectricidad.com</strong>  Su servidor web ha vencido en la fecha 16/07/2020.</p>
        </div>
        <div class="row">
        <div class="col-xs-2">
            <h2>¿Continuar?</h2>
        ...
        <br>
        <div class="col-xs-12">
            <h4>Para una posible reconexión comuniquese con su servicio técnico/informático.</h4>
        </div>
        <!-- <div class="col-xs-2">
            <button class="btn btn-primary" onclick="window.location.href='logueo'">Continuar ...</button>
        </div> -->
