...
<html lang="es">
    <head>
        ...
        <!-- <link type="text/css" rel="stylesheet" href="../assets/css/autocomplete.css"></link> -->
    </head>
    <body>
        <div class="container">
                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                if ($nivel_id == 1) {
                                    ?>
                                    <li><a href="../productos/preciosHistoricos.php">Precios Históricos</a></li>
                                    <li class="divider"></li>
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a href="../stock/index_1.php">Pto. Reposición</a></li>
                            </ul>
                        </li>
                        <?php
                        if ($nivel_id == 1) {
